...
The term "military" itself is already a notable change from the Bush administration. Rather than focusing on the perceived enemy or the perceived threat, the Obama administration appeals to the state of the Americans serving in the military. This appears to be a shift that corresponds with the changing public opinion of the war---Obama was, to a large extent, elected on promises of changing the militarism of the preceding administration, and his rhetoric mirrors that. The association of "peace" and "security," however, reveals the extent to which a change in rhetoric is separated from a change in policy. "Peace" would imply a cessation of hostilities, but "security" is the term used to justify maintaining a military presence in Iraq and Afghanistan. It is still a military word, but one that emphasizes the safety that would appear to result from hostility. "Needs" would appear to fit in with this framework, deferring to a sense of the necessity of maintaining a military presence for the sake of "peace" and "security." "Words" is a peculiar outlier; at this point explanation for this peculiar binary would require more in-depth study.

Both the Obama and Bush administrations use militaristic rhetoric in close proximity with the things they use to justify military action. For Bush, this expresses itself as an association of terrorism with the thing that terrorism is said to threaten. This works both specifically in a fear-mongering sense, but also abstractly in an ideological sense. For Obama, the use is somewhat different. In the first place, "terrorism" itself has dropped entirely out of the equation. Additionally, the terms are almost all conceptual. Individual terrorists give way to entire militaries; the lone agent gives way to the entire global community. This split would seem to reflect the more basic ideological divisions of the premiers. The Bush administration was more isolationist in terms of cooperation and more interfering in military matters; the Obama administration is feeding off the widespread dissatisfaction with those policies, and as such is focussing on global community and the bare minimum of involvement. The extent to which this affects the underlying associations of their words is remarkable.

###3. Conclusions

In general, our expectations were confirmed. The Obama administration largely abandoned the rhetorical figure of the terrorist, but only to replace it with the larger military force. The specific threats and fear-mongering of the Bush administration have become the elusive optimism and appeal to the global community of Obama's speeches. Underlying the current premier, though, is a reluctance to abandon military action that is evident in his rhetorical strategies. The dubious claims that the current foreign wars are protecting American citizens remains in full force. The difference is that it is wrapped in a veneer of hopefulness and the hanging promise of change.

This is an extremely modest iteration of what we hope will be a larger project. In an expanded version of this first part, a larger corpus would be necessary as well as more sophisticated tagging of speeches according to topic. It would also be useful to dig deeper into semantic analysis, considering the words that precede and follow iterations of these words. More keywords could also be identified and traced. We hope, though, that this has provided a beginning.
